...
import com.example.foody.Booking.activity_booking;
import com.example.foody.Delivery.activity_delivery;
import com.example.foody.Discovery.activity_discovery;
...
public class  fragment_home extends Fragment {
    ...
    public void createTabFragment() {
        ...
        pageAdapter.addFragment(new fragment_home_sub1(), "Xem gần đây");
        pageAdapter.addFragment(new fragment_home_sub2(), "Gần tôi");
